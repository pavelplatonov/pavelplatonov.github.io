		...
		<div class="content-innertube">
			...
			<ul id="contact-columns" class="clearfix">
				...
				<li>
					...
					<p></p>
					<a href="https://alphabetazeta.t.me/">Telegram</a></p>
				</li>
				
				<li>
					<img src="img/mail-icon.png" alt="" title="">
					<p><a href="mailto:pavelplaton@gmail.com">pavelplaton@gmail.com</a></p>
				</li>
		...
		<div id="footer">
				...
				<div id="footer-innertube">
					...
					<div id="footer-resume">
						<h5>Резюме</h5>
						<div id="Скачать резюме"><a href="#"></a></div>
